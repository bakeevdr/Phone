...
// $DropDownMenu[] = '<li><a href="files/docreguserad.pdf" download="Регламент регистрации пользователей в AD.pdf">Регламент регистрации пользователей в AD</a></li>';
// $DropDownMenu[] = '<li><a href="changelog.htm">История изменений</a></li>';
